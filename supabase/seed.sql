...
('Sales Performance Analytics', 'Charoen Pokphand Food | Power BI', 'Developed sales and customer-tier reporting across more than 5,000 outlets, saving approximately 12 reporting hours each week.', '["Power BI","Sales Analytics","Retail Data","Business Reporting"]', '2026', '/assets/sales-performance-analyst_compressed.pdf', NULL, true, 1),
